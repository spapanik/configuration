...
set -g status-style bg=$base02,fg=$base01,align=centre
...
set -g status-right "#[bg=$base02,fg=$base01]#[bg=$base01,fg=$base3] #(date +%T) #[bg=$base01,fg=$base00]#[bg=$base00,fg=$base3] %a #[bg=$base00,fg=$base0]#[bg=$base0,fg=$base3] #(date +%F) "
